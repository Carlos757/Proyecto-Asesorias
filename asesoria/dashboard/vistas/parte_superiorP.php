  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="indexP.php">
        ...
        <div class="sidebar-brand-text mx-3">Asesorias</div>
      </a>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <div class="topbar-divider"></div>
              <li class="nav-item dropdown no-arrow text-bottom  mt-4">
                <span class="badge badge-primary "><?php echo $_SESSION["tipo"];?></span>
              </li>
            <div class="topbar-divider"></div>
